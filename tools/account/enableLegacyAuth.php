...
if (!empty($_POST['u']) AND !empty($_POST['p']))
{
	...
	if ($pass)
	{
		...
		echo "<p>Token set! <br /> <code>$token</code> <br /> Use this token in place of the password when logging into a 2.2 client. <br /> Please keep it safe! For your security, you will not be able to view this token upon closing the page.</p>";
	}
	else
	{
