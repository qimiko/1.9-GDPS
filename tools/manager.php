...
$rd = array("change-password" => "account/changePassword.php",
			...
			"reset-password" => "account/resetPassword.php",
			"new-session" => "newSession.php",
			"check-session" => "checkSession.php",
			...
			"epic-levels" => "stats/epicLevels.php",
			...
			"banned-users" => "stats/bannedUsers.php",
			...
			"fix-cps" => "cron/fixcps.php",
			"autoban" => "cron/autoban.php",
			"remove-invalid-data" => "deleteInvalidUsersAndSongs.php",
			...
			"comment-ban" => "mod/commentBan.php",
			"shared-cp" => "mod/sharedcp.php",
